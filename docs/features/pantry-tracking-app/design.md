...
> Moved to `docs/features/recipe-management/design.md`.
...
> Moved to `docs/features/recipe-management/design.md`. Schema defined in `data-model.md`.
...
interface PantryAppDB {
  ...
  recipes: {
    // See docs/features/recipe-management/design.md
    key: string;        // recipeId
    value: Recipe;
...
> Moved to `docs/features/recipe-management/requirements.md` and `docs/features/recipe-management/design.md`.
