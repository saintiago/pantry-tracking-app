...
Shared infrastructure terms (Pantry_App, Beautiful_User, Storage_Location, etc.) are defined in the main spec at `docs/features/pantry-tracking-app/requirements.md`.
