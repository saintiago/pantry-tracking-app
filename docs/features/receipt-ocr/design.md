...
Data models (Receipt, ExtractedItem) and API contracts (receipt routes, request/response interfaces) are defined in `docs/architecture/data-model.md`.
...
This feature uses existing data models defined in the [data-model steering file](../../architecture/data-model.md). No new DynamoDB entities are introduced beyond what is already defined there.
