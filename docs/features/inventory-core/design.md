...
Data models and API routes are defined in the shared steering file: `docs/architecture/data-model.md`
...
Request/response interfaces are defined in `docs/architecture/data-model.md`
