...
import { LowStockBadge } from '../components/InventoryList';
...
// Re-export shared types and helpers from ItemDetailView for backward compatibility
export type {
  EditFormState,
  EditFormErrors,
} from '../components/ItemDetailView';
export { validateEditForm } from '../components/ItemDetailView';
