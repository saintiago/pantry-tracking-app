...
export const UNIT_METADATA = {
  ...
  oz: { key: 'oz', singular: 'ounce', abbreviation: 'oz', plural: 'ounces' },
  lb: { key: 'lb', singular: 'pound', abbreviation: 'lb', plural: 'pounds' },
  floz: {
    key: 'floz',
  ...
  pint: { key: 'pint', singular: 'US pint', abbreviation: 'pt', plural: 'US pints' },
  quart: { key: 'quart', singular: 'US quart', abbreviation: 'qt', plural: 'US quarts' },
  gallon: { key: 'gallon', singular: 'US gallon', abbreviation: 'gal', plural: 'US gallons' },
